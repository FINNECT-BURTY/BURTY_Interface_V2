...
import com.berty.domain.repository.SocialAccountRepository;
...
class BertyE2ETests {
    ...
    @Test
    void socialLoginIssuesBertyTokenAndPersistsAccount() {
        String base = "http://localhost:" + port;
        ResponseEntity<String> login = restTemplate.postForEntity(
                base + "/api/berty/auth/social/kakao/login",
    ...
    @Test
    void googleSocialLoginIssuesBertyToken() {
        String base = "http://localhost:" + port;
        ResponseEntity<String> login = restTemplate.postForEntity(
                base + "/api/berty/auth/social/google/login",
    ...
    void profileOnboardingAfterSocialLogin() {
        ...
        ResponseEntity<String> onboard = restTemplate.postForEntity(
                base + "/api/berty/onboarding/profile",
    ...
    void demoSessionSeedsCashflowScenarioAndReturnsToken() {
        ...
        ResponseEntity<String> demo = restTemplate.postForEntity(
                base + "/api/berty/auth/demo/session",
    ...
    void authToConsultToFamilyAlertFlow() throws Exception {
        ...
        ResponseEntity<String> alerts = restTemplate.exchange(
                base + "/api/berty/family-alerts?userId=" + userId,
