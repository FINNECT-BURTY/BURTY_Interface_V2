...
import com.berty.config.SocialLoginProperties;
import com.berty.core.error.enums.ErrorCode;
import com.berty.core.exception.BusinessException;
import com.berty.domain.entity.SocialAccountEntity;
...
import com.berty.security.oauth.OAuthStateStore;
...
public class SocialLoginService implements SocialLoginUseCase {
    ...
    private SocialProfile stubProfile(String provider, String code) {
        ...
        return new SocialProfile(id, id + "@stub.berty.local", provider + " 사용자");
    }
