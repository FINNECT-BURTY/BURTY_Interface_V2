...
import com.berty.domain.repository.BaseCodeRepository;
...
public class  BaseCodeSeeder {
    ...
    public void seed() {
        ...
        log.info("BaseCode seeder inserted={} rows", inserted);
        if (inserted > 0) {
    ...
    private long seedAccountTypes() {
        return seedGroup(CodeGroups.ACCOUNT_TYPE, List.of(
    ...
    private long seedInstitutionTypes() {
        return seedGroup(CodeGroups.INSTITUTION_TYPE, List.of(
    ...
    private long seedExpenseCategories() {
        return seedGroup(CodeGroups.EXPENSE_CATEGORY, List.of(
    ...
    private long seedIncomeCategories() {
        return seedGroup(CodeGroups.INCOME_CATEGORY, List.of(
    ...
    private long seedScheduleTypes() {
        return seedGroup(CodeGroups.SCHEDULE_TYPE, List.of(
                ...
                row("SUBSCRIPTION_DAY", "구독료 결제일", "Subscription Day", 60, "EXPENSE", "ENTERTAIN", null)
        ));
    }

    private long seedActionTypes() {
        return seedGroup(CodeGroups.ACTION_TYPE, List.of(
                row("FOOD_BUDGET_CUT", "식비 예산 조정", "Reduce Food Budget", 10, "85", "80000", null),
                row("CARD_DUE_DATE_CHANGE", "카드 결제일 이동", "Move Card Due Date", 20, "78", "120000", null),
                row("DEBT_PRIORITY_CHANGE", "고금리 상환 우선", "Prioritize High-rate Debt", 30, "65", "60000", null),
                row("DEFER_NON_ESSENTIAL", "비필수 지출 보류", "Defer Non-essential", 40, "72", "150000", null),
                row("EMERGENCY_POLICY_CHECK", "긴급 정책 확인", "Check Emergency Policy", 50, "90", "200000", null),
    ...
    private long seedRiskLevels() {
        return seedGroup(CodeGroups.RISK_LEVEL, List.of(
    ...
    private long seedOccupationTypes() {
        return seedGroup(CodeGroups.OCCUPATION_TYPE, List.of(
    ...
    private long seedResidenceTypes() {
        return seedGroup(CodeGroups.RESIDENCE_TYPE, List.of(
    ...
    private long seedPolicyTypes() {
        return seedGroup(CodeGroups.POLICY_TYPE, List.of(
    ...
    private long seedMerchantKeywords() {
        return seedGroup(CodeGroups.MERCHANT_KEYWORD, List.of(
    ...
    private long seedNotificationTypes() {
        return seedGroup(CodeGroups.NOTIFICATION_TYPE, List.of(
    ...
    private long seedAlertTypes() {
        return seedGroup(CodeGroups.ALERT_TYPE, List.of(
    ...
    private long seedSectionTypes() {
        return seedGroup(CodeGroups.SECTION_TYPE, List.of(
    ...
    private long seedConsentTypes() {
        return seedGroup(CodeGroups.CONSENT_TYPE, List.of(
                ...
                row("SECURITY_LOG", "접속 보안 로그", "Security Access Log", 50, "IP/DEVICE/APPROX_REGION", "SECURITY", null),
                row("LOCATION_POLICY_MATCH", "지역 기반 정책 추천", "Location Policy Match", 60, "USER_RESIDENCE", "SERVICE", null)
        ));
    }

    private long seedRelations() {
        return seedGroup(CodeGroups.RELATION, List.of(
    ...
    private long seedActorTypes() {
        return seedGroup(CodeGroups.ACTOR_TYPE, List.of(
    ...
    private long seedChannels() {
        return seedGroup(CodeGroups.CHANNEL, List.of(
    ...
    private long seedPurposes() {
        return seedGroup(CodeGroups.PURPOSE, List.of(
    ...
    private long seedPeriodTypes() {
        return seedGroup(CodeGroups.PERIOD_TYPE, List.of(
    ...
    private long seedEasyReadDict() {
        return seedGroup(CodeGroups.EASY_READ_DICT, List.of(
    ...
    private static SeedRow row(String value, String ko, String en, int sort, String attr1, String attr2, String attr3) {
        return new SeedRow(value, ko, en, sort, attr1, attr2, attr3);
    }

    private record SeedRow(String value, String nameKo, String nameEn, int sort, String attr1, String attr2, String attr3) {}
}
