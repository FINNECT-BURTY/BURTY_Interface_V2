...
import com.berty.adapter.in.web.dto.LoginRiskEvaluateRequest;
import com.berty.adapter.in.web.dto.LoginRiskEvaluateResponse;
...
@RestController
@RequestMapping("/api/berty/security/login-risk")
@Tag(name = "BERTY Login Risk", description = "새 기기/IP/시간대 기반 이상 로그인 평가 API")
