...
import com.berty.adapter.in.web.dto.PolicyAdminRequest;
import com.berty.adapter.in.web.dto.PolicyAdminResponse;
...
@RestController
@RequestMapping("/api/berty/admin/policies")
@Tag(name = "BERTY Policy Admin", description = "정책 데이터 최신화/관리자 API")
