...
import com.berty.application.port.in.WebAuthnUseCase;
...
import com.berty.adapter.out.alert.FamilyAlertSseBroker;

@RestController
@RequestMapping("/api/berty")
@Tag(name = "BERTY Finance API", description = "BERTY 금융 상담/보안/가족보호/외부금융 연동 API")
public class BertyController extends BaseController {
    private final BertyUseCase moneyAgentUseCase;
    ...
    public BertyController(BertyUseCase moneyAgentUseCase, WebAuthnUseCase webAuthnUseCase,
