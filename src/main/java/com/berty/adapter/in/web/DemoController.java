...
import com.berty.domain.repository.PersonaProfileRepository;
...
@RestController
@RequestMapping("/api/berty/auth/demo")
@Tag(name = "BERTY Demo", description = "MVP 시연용 사용자와 현금흐름 데이터를 생성합니다.")
