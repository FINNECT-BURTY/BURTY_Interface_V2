...
import com.berty.adapter.in.web.dto.AiFallbackTemplateRequest;
...
import com.berty.domain.repository.AiFallbackTemplateRepository;
...
@RestController
@RequestMapping("/api/berty/admin/ai-templates")
@Tag(name = "BERTY AI Template Admin", description = "AI fallback 문구 템플릿 관리 API")
