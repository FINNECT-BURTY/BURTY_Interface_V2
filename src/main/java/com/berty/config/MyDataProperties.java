...
@Component
@ConfigurationProperties(prefix = "berty.mydata")
public class MyDataProperties {
    private String clientId = "berty-client";
    private String clientSecret = "berty-secret";
    ...
    private String redirectUri = "http://localhost:8080/api/berty/mydata/oauth/callback";
