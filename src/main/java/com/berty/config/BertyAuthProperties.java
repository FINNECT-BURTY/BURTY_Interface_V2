 ...
 */
@Component
@ConfigurationProperties(prefix = "berty.auth")
public class BertyAuthProperties {

    /**
     * {@code POST /api/berty/auth/token} 허용 여부. {@code spring.profiles.active}에 prod가 있으면 무조건 비활성화됩니다.
     */
