...
public class FamilyDashboardSummary {
    private String userId;
    private int alertCount;
    private int unusualTransactionCount;
    private int monthlyReportDeliveredCount;

    public FamilyDashboardSummary(String userId, int alertCount, int unusualTransactionCount, int monthlyReportDeliveredCount) {
        this.userId = userId;
