...
public class YouthCenterApiResponse {
    ...
    public static class PolicyItem {
        ...
        public void setPlcyExplnCn(String v) { this.plcyExplnCn = v; }
        ...
        public void setPlcySprtCn(String v) { this.plcySprtCn = v; }
        public String getSprvsnInstCdNm() { return sprvsnInstCdNm; }
        public void setSprvsnInstCdNm(String v) { this.sprvsnInstCdNm = v; }
        public String getOperInstCdNm() { return operInstCdNm; }
        public void setOperInstCdNm(String v) { this.operInstCdNm = v; }
        public String getAplyPrdSeCd() { return aplyPrdSeCd; }
        public void setAplyPrdSeCd(String v) { this.aplyPrdSeCd = v; }
        public String getBizPrdBgngYmd() { return bizPrdBgngYmd; }
        public void setBizPrdBgngYmd(String v) { this.bizPrdBgngYmd = v; }
        public String getBizPrdEndYmd() { return bizPrdEndYmd; }
        public void setBizPrdEndYmd(String v) { this.bizPrdEndYmd = v; }
        public String getPlcyAplyMthdCn() { return plcyAplyMthdCn; }
        public void setPlcyAplyMthdCn(String v) { this.plcyAplyMthdCn = v; }
        public String getAplyUrlAddr() { return aplyUrlAddr; }
        public void setAplyUrlAddr(String v) { this.aplyUrlAddr = v; }
        public String getRefUrlAddr1() { return refUrlAddr1; }
        public void setRefUrlAddr1(String v) { this.refUrlAddr1 = v; }
        public String getSprtTrgtMinAge() { return sprtTrgtMinAge; }
        public void setSprtTrgtMinAge(String v) { this.sprtTrgtMinAge = v; }
        public String getSprtTrgtMaxAge() { return sprtTrgtMaxAge; }
        public void setSprtTrgtMaxAge(String v) { this.sprtTrgtMaxAge = v; }
        public String getSprtTrgtAgeLmtYn() { return sprtTrgtAgeLmtYn; }
        public void setSprtTrgtAgeLmtYn(String v) { this.sprtTrgtAgeLmtYn = v; }
        ...
        public void setEarnCndSeCd(String v) { this.earnCndSeCd = v; }
        public String getEarnMinAmt() { return earnMinAmt; }
        public void setEarnMinAmt(String v) { this.earnMinAmt = v; }
        public String getEarnMaxAmt() { return earnMaxAmt; }
        public void setEarnMaxAmt(String v) { this.earnMaxAmt = v; }
        public String getEarnEtcCn() { return earnEtcCn; }
        public void setEarnEtcCn(String v) { this.earnEtcCn = v; }
        public String getMrgSttsCd() { return mrgSttsCd; }
        public void setMrgSttsCd(String v) { this.mrgSttsCd = v; }
        public String getJobCd() { return jobCd; }
        public void setJobCd(String v) { this.jobCd = v; }
        public String getSchoolCd() { return schoolCd; }
        public void setSchoolCd(String v) { this.schoolCd = v; }
        public String getSBizCd() { return sBizCd; }
        public void setSBizCd(String v) { this.sBizCd = v; }
        public String getAplyYmd() { return aplyYmd; }
        public void setAplyYmd(String v) { this.aplyYmd = v; }
        public String getFrstRegDt() { return frstRegDt; }
        public void setFrstRegDt(String v) { this.frstRegDt = v; }
        public String getLastMdfcnDt() { return lastMdfcnDt; }
        public void setLastMdfcnDt(String v) { this.lastMdfcnDt = v; }
        public String getInqCnt() { return inqCnt; }
        public void setInqCnt(String v) { this.inqCnt = v; }
    }
}
