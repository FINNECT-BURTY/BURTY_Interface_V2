 ...
 *
 * <pre>
 * <b>Description  : 외부연동 외부 연동 어댑터 (HanaBankApiAdapter)</b>
...
@Component
public class HanaBankApiAdapter extends AbstractBankTransferAdapter implements HanaBankPort {
  ...
  public Map<String, Object> transfer(String userId, String toAccount, long amount) {
    return transfer(
        "HANA_BANK",
        properties.getHanaTransferUrl(),
        properties.getHanaApiKey(),
        userId,
        toAccount,
        amount);
  }
