 ...
 *
 * <pre>
 * <b>Description  : 소셜로그인 (SocialProviderStrategy)</b>
...
/**
 * Provider 별로 다른 OAuth 디테일(authorize URL 추가 파라미터, userinfo 응답 파싱, Apple 처럼 id_token 직접 처리 등)을 캡슐화.
 * 새 provider 추가 시 strategy 클래스 1개만 추가.
 */
