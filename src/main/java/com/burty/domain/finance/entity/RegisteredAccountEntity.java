 ...
 *
 * <pre>
 * <b>Description  : 금융 엔티티 (RegisteredAccountEntity)</b>
...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_registered_account_pair",
          columnNames = {"user_id", "account_no"})
    },
    indexes = {@Index(name = "idx_registered_account_user", columnList = "user_id")})
@Getter
@Setter
@NoArgsConstructor
