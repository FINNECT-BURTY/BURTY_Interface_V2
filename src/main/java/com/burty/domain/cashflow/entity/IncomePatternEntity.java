 ...
 *
 * <pre>
 * <b>Description  : 현금흐름 엔티티 (IncomePatternEntity)</b>
...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_income_user_month",
          columnNames = {"user_id", "period_yyyymm"})
    },
    indexes = {@Index(name = "idx_income_user", columnList = "user_id")})
@Getter
@Setter
@NoArgsConstructor
