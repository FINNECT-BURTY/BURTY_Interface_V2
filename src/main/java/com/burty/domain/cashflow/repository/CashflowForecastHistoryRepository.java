 ...
 *
 * <pre>
 * <b>Description  : 현금흐름 리포지토리 (CashflowForecastHistoryRepository)</b>
...
public interface CashflowForecastHistoryRepository
    extends JpaRepository<CashflowForecastEntity, Long> {
  Optional<CashflowForecastEntity> findByUserIdAndForecastDate(
      String userId, LocalDate forecastDate);
