 ...
 *
 * <pre>
 * <b>Description  : 현금흐름 리포지토리 (RecurringExpenseRepository)</b>
...
public interface RecurringExpenseRepository extends JpaRepository<RecurringExpenseEntity, Long> {
  ...
  List<RecurringExpenseEntity> findByUserIdAndExpenseCategoryCodeAndActiveTrue(
      Long userId, String expenseCategoryCode);
}
