 ...
 *
 * <pre>
 * <b>Description  : 마이데이터 엔티티 (MyDataLinkStatusEntity)</b>
...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_mydata_link_user_inst",
          columnNames = {"user_id", "institution_code"})
    },
    indexes = {@Index(name = "idx_mydata_link_user", columnList = "user_id")})
@Getter
@Setter
@NoArgsConstructor
