 ...
 *
 * <pre>
 * <b>Description  : 보안 인터셉터 (ResourceOwnershipInterceptor)</b>
...
/**
 * URL/쿼리의 {@code userId}가 JWT subject와 일치하는지 검사해 IDOR를 방지합니다. {@code @RequestBody} JSON 내부의 userId는
 * 이 인터셉터 범위 밖이므로, 해당 API는 추후 본문 검증 또는 /me 스타일로 이전하는 것이 좋습니다.
 */
@Component
