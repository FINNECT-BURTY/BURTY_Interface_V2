 ...
 *
 * <pre>
 * <b>Description  : 코어 (RetryAspect)</b>
...
import com.burty.core.annotation.Retryable;
...
public class RetryAspect {
   ...
   */
  @Around("@annotation(com.burty.core.annotation.Retryable)")
    ...
    for (int attempt = 1; attempt <= maxAttempts; attempt++) {
      try {
        ...
        if (attempt == maxAttempts) {
          log.error(
              "All {} attempts failed for method {}",
              maxAttempts,
        ...
        log.warn(
            "Attempt {} failed for method {}, retrying in {}ms",
            attempt,
            joinPoint.getSignature().toShortString(),
            delay);
