 ...
 *
 * <pre>
 * <b>Description  : 관리 (ActionRecommendationSeeder)</b>
  ...
  public void seed() {
    ...
    inserted +=
        upsert(
            ...
            null,
            null);
    log.info(LogMessages.Admin.ACTION_RECOMMENDATION_SEEDER, inserted);
  }
