...
import com.burty.application.port.out.*;
import com.burty.domain.entity.ActionExecutionEntity;
...
import com.burty.domain.repository.FamilyConsentRepository;
...
@Service
public class BurtyService implements BurtyUseCase {
    private static final long FAMILY_ALERT_THRESHOLD = 1_000_000L;
    private static final long LARGE_TRANSFER_THRESHOLD = 3_000_000L;
    private static final Logger log = LoggerFactory.getLogger(BurtyService.class);
    ...
    public BurtyService(EasyReadPort easyReadPort,
